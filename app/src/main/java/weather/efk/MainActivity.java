...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    static String lat;
    static String lon;
    private final String appid = "757a0f2fcf9e1f4324d03a73022aa64a";
    ...
    private void WeatherByCityName(String city){
        ...
        Request request=new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/forecast?q="+city+"&appid="+appid+"&units=metric")
                .get().build();
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            case R.id.Register:
                ...
                break;
            case R.id.Sign_in:
                Intent S_intent = new Intent(MainActivity.this,LoginActivity.class);
            ...
            case R.id.City_Search:
                ...
                break;
            case R.id.User_info:
                Intent U_intent=new Intent(MainActivity.this,UserInformation.class);
                startActivity(U_intent);
                break;
            case R.id.Preferences:
                Intent P_intent=new Intent(MainActivity.this,UserPreferencesActivity.class);
                startActivity(P_intent);
                break;
            case R.id.Recommendations:
                Intent Rec_intent=new Intent(MainActivity.this,RecommendationsActivity.class);
